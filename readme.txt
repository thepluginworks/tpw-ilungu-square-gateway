...
TPW Square Gateway is the Square payments add-on for FlexiClub. It keeps Square configuration and checkout support in a dedicated plugin while preserving the existing TPW payment flow used by live sites.

Use this plugin when your FlexiClub-powered site needs Square payments without changing the established TPW checkout experience.

== Requirements ==

* WordPress 6.0 or higher
* PHP 7.4 or higher
* FlexiClub installed and active
...
4. Open the FlexiClub payment settings and go to the Square settings page.
...
= Does this plugin work without FlexiClub? =

No. TPW Square Gateway extends FlexiClub and should be used alongside an active FlexiClub installation.
